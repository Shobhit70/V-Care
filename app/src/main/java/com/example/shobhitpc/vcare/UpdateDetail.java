...
import static com.example.shobhitpc.vcare.Register.DIALOG_ID;

/**
 * Created by shobhit pc on 13-Jul-17.
 */

public class UpdateDetail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.medicationlist);
